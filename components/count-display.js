...
export default function CountDisplay(props) {
  ...
  return (
    <Fragment>
      ...
      <CountDescription isNewCount={props.isNewCount} count={props.count}></CountDescription>
    </Fragment>
  )
}
...
function CountDescription(props) {
  ...
  if (props.isNewCount === true) { // TODO: Nicely wrap this text
    ...
    countDescription = "Note: after payment please wait a few seconds and the count should appear on the page. Do not refresh!"
  }
