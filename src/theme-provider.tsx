...
export const CustomThemeProvider: React.FC<ThemeProviderProps> = ({ children }: ThemeProviderProps) => {
  ...
  return (
    <ToggleThemeContext.Provider value={{ toggleTheme, darkThemeActive: !(selectedTheme.themeName === 'lightTheme') }}>
